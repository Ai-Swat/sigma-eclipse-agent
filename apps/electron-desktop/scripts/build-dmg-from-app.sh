...
APP_NAME=$(/usr/libexec/PlistBuddy -c "Print CFBundleName" "$APP_PATH/Contents/Info.plist" 2>/dev/null || echo "Sigma Eclipse")
...
# appdmg writes .DS_Store at the binary level — no Finder/AppleScript needed.
